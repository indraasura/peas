...
-- First, drop existing check constraints that might conflict
ALTER TABLE public.areas DROP CONSTRAINT IF EXISTS check_area_status;
ALTER TABLE public.areas DROP CONSTRAINT IF EXISTS areas_status_check;
ALTER TABLE public.pods DROP CONSTRAINT IF EXISTS check_pod_status;
ALTER TABLE public.pods DROP CONSTRAINT IF EXISTS pods_status_check;
