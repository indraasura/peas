...
-- This script ensures a clean state for authentication

-- Step 1: Disable RLS temporarily to fix any issues
...
-- Step 3: Clear all profiles (WARNING: This deletes all profiles)
DELETE FROM public.profiles;

-- Step 4: Create a test profile for swaruph@linecraft.ai
...
-- Step 10: Test a simple query (this should work without errors)
